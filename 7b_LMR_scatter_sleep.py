...
model = Lmer("accuracy ~ sleep_freshBefore_c + names_flag + interf + names_flag:interf + (1 + names_flag + interf + names_flag:interf | nth_participant)", data=accuracy, family="binomial")
model.fit()
